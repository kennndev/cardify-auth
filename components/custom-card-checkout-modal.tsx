          ...
          <div className={
            ...
            <div className="relative w-full h-full rounded-xl border-2 border-cyber-cyan/50 shadow-2xl overflow-hidden">
              ...
              <img
                src={uploadedImage}
                alt="Custom Card"
                className="w-full h-full object-fill rounded-xl image-high-quality"
                style={{
                  willChange: 'transform',
                    ...
                    <div className="relative w-full max-w-[200px] sm:max-w-xs lg:max-w-sm">
                      ...
                      >
                        <CustomCard3DPreviewWrapper
                          key={`3d-preview-${uploadedImage || 'placeholder'}-${animationKey}`}
                          animationKey={animationKey}
                          cardFrontImage={uploadedImage || "/placeholder.jpg"}
